...
### Blog Articles
- [Middleware in ASP.NET Core - How to Use It for Dependency Injection](https://www.devleader.ca/2023/12/18/middleware-in-asp-net-core-how-to-use-it-for-dependency-injection)

### YouTube Videos  
- [Middleware in ASP.NET Core - How to Use It for Dependency Injection](https://www.youtube.com/watch?v=EkHELO3CmIE)
