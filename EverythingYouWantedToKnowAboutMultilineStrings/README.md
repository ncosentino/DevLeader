# Multiline Strings in C# – Verbatim Strings, Raw String Literals & More
...
This example highlights the different ways to work with multiline strings. To read more about this, you can check out the corresponding blog post found here:

[Everything You Wanted to Know About Multiline Strings](https://www.devleader.ca/2023/02/01/everything-you-wanted-to-know-about-multiline-strings/)
...
* Verbatim strings and raw string literals are more advanced techniques you can use
