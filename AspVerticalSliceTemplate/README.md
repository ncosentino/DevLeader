# ASP.NET Vertical Slice Architecture Template – Free Project Template for C#
...
This solution will contain projects that help explain concepts around vertical slice architecture. You can find out more about that here:

- [Vertical Slice Template – Dev Leader Weekly 15](https://www.devleader.ca/2023/10/28/vertical-slice-template-dev-leader-weekly-15)
- [FREE Vertical Slice Project Template - ASP.NET Core + Autofac](https://youtu.be/g_g7pYGCnik)
